...
class HCarouselView(
    ...
    private val activeColor by lazy { ContextCompat.getColor(context, R.color.purple_200) }
    private val inactiveColor by lazy { ContextCompat.getColor(context, R.color.black) }
